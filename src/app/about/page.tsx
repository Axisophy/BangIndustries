          ...
          <div>
            <ol className='space-y-8'>
              <li className='flex gap-4'>
                <span className='text-xs font-mono text-black/50 pt-1'>01</span>
                <div>
              ...
              <li className='flex gap-4'>
                <span className='text-xs font-mono text-black/50 pt-1'>02</span>
                <div>
              ...
              <li className='flex gap-4'>
                <span className='text-xs font-mono text-black/50 pt-1'>03</span>
                <div>
              ...
              <li className='flex gap-4'>
                <span className='text-xs font-mono text-black/50 pt-1'>04</span>
                <div>
              ...
              <li className='flex gap-4'>
                <span className='text-xs font-mono text-black/50 pt-1'>05</span>
                <div>
      ...
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16'>
          ...
          <div className='space-y-8'>
            <div>
              <h3 className='text-xl md:text-2xl lg:text-3xl font-bold tracking-tight mb-1'>Accuracy matters</h3>
              <p className='text-black/70'>
            ...
            <div>
              <h3 className='text-xl md:text-2xl lg:text-3xl font-bold tracking-tight mb-1'>Clarity over decoration</h3>
              <p className='text-black/70'>
            ...
            <div>
              <h3 className='text-xl md:text-2xl lg:text-3xl font-bold tracking-tight mb-1'>Systems thinking</h3>
              <p className='text-black/70'>
