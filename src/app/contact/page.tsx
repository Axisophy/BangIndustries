            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-black/20 bg-transparent focus:border-black focus:outline-none transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-black/20 bg-transparent focus:border-black focus:outline-none transition-colors appearance-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="What are you trying to communicate? Who needs to understand it? Any constraints or timelines?"
                  className="w-full px-4 py-3 border border-black/20 bg-transparent focus:border-black focus:outline-none transition-colors resize-none placeholder:text-black/30"
                />
              </div>
